...
async def run(playwright: Playwright, __next=None):
    ...
    renewal_urlCarTPL = "https://saladin.vn/renewal/zns?policy_id=P4559194770&env=staging"
    # sokhung = "SOKHUNG"
    # bienso = "14N11234"

    # Renewal Car TPL
    # [to: 84933188294] ["Test CAR anonymous 603326","P4559194770","12-04-2025 23:59:00","Test CAR anonymous 603326",
    # "P4559194770","Ô tô","480,700đ","Liên hệ ngay Saladin để được gia hạn và đảm bảo quyền lợi",
    # "renewal/zns?policy_id=P4559194770\u0026env=staging"]
