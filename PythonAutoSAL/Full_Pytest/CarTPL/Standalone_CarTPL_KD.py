...
# Insurer PVI KKD CN
def test_CarTPL_PVI_KD_CN_K_promo(set_up_page: Page, ):
...
def test_CarTPL_BaoMinh_KD_CN_TL_promo(set_up_page: Page):
    product_detail = "Bảo hiểm ô tô"
...
def test_CarTPL_BaoViet_KD_PickupMinivan_K_promo(set_up_page: Page):
    product_detail = "Bảo hiểm ô tô"
...
def test_CarTPL_BSH_KD_PickupMinivan_TL_promo(set_up_page: Page):
    product_detail = "Bảo hiểm ô tô"
    insurer_detail = "BSH"
    numberseat = "5"
    kdvt_value = "Có"
...
def test_CarTPL_VNI_KD_Chohang_K_promo(set_up_page: Page):
    product_detail = "Bảo hiểm ô tô"
    insurer_detail = "VNI"
    numberseat = "2"
    kdvt_value = "Có"
